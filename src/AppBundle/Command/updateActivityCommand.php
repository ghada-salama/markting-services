...
class updateActivityCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        ...
        ->setName('app:updateActivitytable')
    ...
    //  $flag=1;
      ...
      $em = $doctrine->getEntityManager();
        ...
        $count= $em->getRepository('AppBundle:OldActivity')->getCount2();  
dump($count);die;
          ...
          // {
                ...
                {
                        $start=new \DateTime();
                        $row= $em->getRepository('AppBundle:OldActivity')->getFirstAsArray2();  
                       // dump($row);die;
                        if($row)
                        {
